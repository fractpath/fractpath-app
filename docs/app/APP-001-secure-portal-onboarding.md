...
2. **Your scenario**
   ...
   - Key highlights: property value, upfront/monthly inputs, horizon
   - Status badge: "Scenario saved", "In review", "Next steps scheduled"
...
No editing yet. This is read-only.
